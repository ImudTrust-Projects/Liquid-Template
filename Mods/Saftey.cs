    ...
    public class Safety
    {
        ...
        public static void AntiReportDisconnect()
        {
            AntiReport((vrrig, position) =>
            {
                ...
                NotifiLib.Send("<color=grey>[</color><color=purple>ANTI-REPORT</color><color=grey>]</color> " + RigManager.GetPlayerFromVRRig(vrrig).NickName + " attempted to report you, you have been disconnected.");
            });
        }
    }
}